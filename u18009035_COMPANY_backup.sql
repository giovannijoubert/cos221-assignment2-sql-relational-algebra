...
--
-- Host: wheatley.cs.up.ac.za    Database: u18009035_COMPANY
-- ------------------------------------------------------
...
CREATE TABLE `DEPENDENT` (
  `Essn` int(9) NOT NULL DEFAULT '0',
  `Dependent_name` varchar(10) NOT NULL DEFAULT '',
  `Sex` enum('M','F') DEFAULT NULL,
  `Bdate` date DEFAULT NULL,
  `Relationship` varchar(9) DEFAULT NULL,
...
CREATE TABLE `DEPT_LOCATIONS` (
  `Dnumber` int(1) NOT NULL DEFAULT '0',
  `Dlocation` varchar(10) NOT NULL DEFAULT '',
...
-- Dump completed on 2019-03-12 20:07:40
